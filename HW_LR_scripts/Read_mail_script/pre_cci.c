# 1 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c"
...
# 1 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
...
# 2 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
...
random_func(){
	...
	lr_save_string(lr_paramarr_random("Message_id"), "Message_id_random");
	   
}
# 9 "globals.h" 2

# 1 "authorization_func.c" 1
authorization_func(){
...
# 3 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
...
# 4 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
...
Action()
{
	...
	lr_end_transaction("Inbox_transaction", 2);
	...
	lr_end_transaction("GoToMail_transaction",2);
	...
	lr_end_transaction("RedirectMail_transaction",2);
	...
	lr_end_transaction("GoInbox_transaction",2);
	}

	return 0;
}
# 5 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
...
# 6 "c:\\program files (x86)\\micro focus\\loadrunner\\read_mail_script\\\\combined_Read_mail_script.c" 2
